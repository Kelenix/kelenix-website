...
async function main() {
  ...
  const services = [
    {
      ...
      faqFr: JSON.stringify([
        { question: "Combien de temps faut-il pour développer un logiciel sur mesure ?", answer: "La durée varie selon la complexité du projet. Un projet simple peut prendre 2-3 mois, tandis qu'une application complexe peut nécessiter 6 à 12 mois. Nous définissons le calendrier précis lors de l'analyse de vos besoins." },
        { question: "Pouvez-vous reprendre un projet existant ?", answer: "Oui, nous pouvons analyser, améliorer ou refactoriser un code existant. Nous commençons par un audit technique pour évaluer l'état du code et proposer les meilleures solutions." },
      ]),
      faqEn: JSON.stringify([
        { question: "How long does it take to develop custom software?", answer: "The duration varies depending on project complexity. A simple project can take 2-3 months, while a complex application may require 6-12 months. We define the precise timeline during the analysis of your needs." },
        { question: "Can you take over an existing project?", answer: "Yes, we can analyze, improve or refactor existing code. We start with a technical audit to assess the state of the code and propose the best solutions." },
      ]),
      order: 1,
    },
    {
      ...
      faqFr: JSON.stringify([
        { question: "Quel est le délai de création d'un site web ?", answer: "Un site vitrine simple prend 2-4 semaines. Un site e-commerce ou un site complexe peut prendre 6-12 semaines selon les fonctionnalités requises." },
      ]),
      faqEn: JSON.stringify([
        { question: "What is the timeline for creating a website?", answer: "A simple showcase site takes 2-4 weeks. An e-commerce site or complex site can take 6-12 weeks depending on required features." },
      ]),
      order: 2,
    },
    {
      ...
      faqFr: JSON.stringify([{ question: "Quelle est la différence entre un site web et une application web ?", answer: "Un site web présente de l'information de façon statique ou semi-dynamique. Une application web offre des fonctionnalités interactives complexes, de la gestion de données et des processus métier automatisés." }]),
      faqEn: JSON.stringify([{ question: "What is the difference between a website and a web application?", answer: "A website presents information in a static or semi-dynamic way. A web application offers complex interactive features, data management and automated business processes." }]),
      order: 3,
    },
    {
      ...
      faqFr: JSON.stringify([{ question: "Vaut-il mieux développer une application native ou cross-platform ?", answer: "Cela dépend de votre budget et de vos besoins. Le cross-platform (React Native, Flutter) est plus économique et maintient une seule codebase. Le natif offre les meilleures performances mais coûte plus cher. Nous vous conseillons selon votre cas." }]),
      faqEn: JSON.stringify([{ question: "Is it better to develop a native or cross-platform application?", answer: "It depends on your budget and needs. Cross-platform (React Native, Flutter) is more economical and maintains a single codebase. Native offers the best performance but costs more. We advise you based on your case." }]),
      order: 4,
    },
    {
      ...
      faqFr: JSON.stringify([{ question: "Mon entreprise a-t-elle besoin de grandes quantités de données pour utiliser l'IA ?", answer: "Pas nécessairement. Selon la solution IA envisagée, nous pouvons utiliser des modèles pré-entraînés, du transfer learning ou des techniques de few-shot learning qui fonctionnent avec peu de données." }]),
      faqEn: JSON.stringify([{ question: "Does my company need large amounts of data to use AI?", answer: "Not necessarily. Depending on the AI solution envisaged, we can use pre-trained models, transfer learning or few-shot learning techniques that work with little data." }]),
      order: 5,
    },
    {
      ...
      faqFr: JSON.stringify([{ question: "À qui s'adresse le consulting IT ?", answer: "Notre service de consulting s'adresse aux entreprises de toutes tailles qui souhaitent optimiser leur utilisation de la technologie : PME en transformation digitale, startups cherchant à scaler, ou grandes entreprises souhaitant moderniser leur SI." }]),
      faqEn: JSON.stringify([{ question: "Who is IT consulting for?", answer: "Our consulting service is aimed at companies of all sizes that want to optimize their use of technology: SMEs in digital transformation, startups looking to scale, or large companies wanting to modernize their information systems." }]),
      order: 6,
    },
    {
      ...
      faqFr: JSON.stringify([{ question: "Les formations sont-elles disponibles en ligne ?", answer: "Oui, nous proposons des formations en présentiel, en ligne (synchrone avec formateur) et en e-learning (à votre rythme). Nous nous adaptons aux contraintes de votre équipe." }]),
      faqEn: JSON.stringify([{ question: "Are training programs available online?", answer: "Yes, we offer in-person, online (synchronous with trainer) and e-learning (at your own pace) training. We adapt to your team's constraints." }]),
      order: 7,
    },
  ];
  ...
  // FAQ générale du site — seed uniquement si la table est vide (préserve les ajouts admin).
  const faqs = [
