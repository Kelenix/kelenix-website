...
const defaultTeam = [
  { name: "Kévin Assou", roleFr: "CEO & Fondateur", roleEn: "CEO & Founder", bioFr: "Ingénieur en informatique avec 10 ans d'expérience, Kévin a fondé Kelenix avec la conviction que la technologie doit être au service de tous.", bioEn: "Computer engineer with 10 years of experience, Kevin founded Kelenix with the conviction that technology must serve everyone.", avatar: "https://ui-avatars.com/api/?name=Kevin+Assou&background=0B1F3A&color=2FA8FF&size=200&bold=true" },
