        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block mb-4">
              <Image src="/logo.png" alt="Kelenix" width={44} height={44} className="h-11 w-11 object-contain rounded-lg" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-sky/10 flex items-center justify-center flex-shrink-0 group-hover:bg-sky/20">
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-3 hover:text-sky transition-colors group"
                >
                  <div className="w-8 h-8 rounded-lg bg-green-600/20 flex items-center justify-center flex-shrink-0 group-hover:bg-green-600/30">
